...
class StudentRegistrationForm(forms.Form):
    ...
    address = forms.CharField(label= 'Address', max_length=200,widget=forms.Textarea(attrs={'cols':'30','rows':'3'}))
    ...
    subclass = forms.ChoiceField(label= 'Sub Class Admitted',choices=(('Nil', 'Nil'),('KG', 'KG'),('Primary', 'Primary'), ('JS', 'JS'), ('Science', 'Science'),('Art', 'Art'),('Commercial', 'Commercial'),('Science/Math','Science/Math'),('Technology','Technology'),('Humanities','Humanities'),('Business','Business'),('Year', 'Year'),('Nursery', 'Nursery')))
    class Meta:
        model = Student
...
class studentreportform(forms.Form):
    ...
    dayboarding = forms.ChoiceField(label='Day/Boarding', choices=(('Day', 'Day'), ('Boarding', 'Boarding')))
    filtermethod = forms.ChoiceField(label='', choices=(('Class', 'Class'), ('Class and Arm', 'Class and Arm'),('Day/Boarding', 'Day/Boarding')))
