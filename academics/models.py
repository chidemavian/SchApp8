...
class SubjectScore(models.Model):
    ...
    def save(self, **kwargs):
        self.term_score = self.first_ca + self.second_ca + self.third_ca + self.fourth_ca+ self.exam_score
        self.mid_term = self.first_ca + self.second_ca + self.third_ca + self.fourth_ca
        ...
        if self.term.startswith('T'):
            if self.klass.startswith('J'):
               ...
               super(SubjectScore, self).save(**kwargs)
                ...
                if (self.annual_avg >=95) and (self.annual_avg <= 100):
                    self.grade = 'A+'
                    self.remark = 'Excellent'
